        ...
        <script>
          ...
          */
          ...
          //     else
          //       data[j]['ketAkun']='';
          //     data[j]['debit'] = table.rows[i].cells[1].children[0].value;
          //     data[j]['kredit'] = table.rows[i].cells[2].children[0].value;
          ...
          function simpanJurnal()
          {
            ...
            // tanggal, akun+ketAkun, debit, kredit
			
           
			   


			    url = 'C_home/tambahJurnal';
          ...
          //   xhttp.send("akun="+data[i]['akun']+"&idAkun="+data[i]['idAkun']+
          //   "&ketAkun="+data[i]['ketAkun']+"&debit="+data[i]['debit']+
          //   "&kredit="+data[i]['kredit']+"&tanggal="+data[i]['tanggal']);
          // }		
            

            xhttp.open("POST", url, true);
            xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            console.log(data[0]['akun']);
            console.log(data[0]['idAkun']);
             console.log(data[0]['ketAkun']);
              console.log(data[0]['debit']);
               console.log(data[0]['kredit']);
               console.log(data[0]['tanggal']);

            xhttp.send("akun="+data[0]['akun']+"&idAkun="+data[0]['idAkun']+
            "&ketAkun="+data[0]['ketAkun']+"&debit="+data[0]['debit']+
            "&kredit="+data[0]['kredit']+"&tanggal="+data[0]['tanggal']);
          ...
          function isiTableJurnal(data)
          {
              ...
              for(i=0; i<data.length; i++)
              {
                ...
                if(i==1)
                {
                  ...
                  cell1.innerHTML = data[i]['tanggal'];
                  var cell2 = row.insertCell(1);
                  var cell3 = row.insertCell(2);
                  var cell4 = row.insertCell(3);
                ...
                cell2.innerHTML = data[i]['akun'];
                if(data[i]['ketAkun'] != '')
                  cell2.innerHTML += '<br><i style="font-size:12px;padding-left:10px">'+data[i]['ketAkun']+'</i>';
                ...
                if(data[i]['debit'] == 0)
                  ...
                  cell3.innerHTML = data[i]['debit'];
                if(data[i]['kredit']==0)
                  cell4.innerHTML = '';
                else
                  cell4.innerHTML = data[i]['kredit'];
              }              
          }

          // function tambahJurnal()
          // {
          //   var namaAkunJurnal = document.getElementById('namaAkun').value;
          ...
          //   var tambahToday = document.getElementById('tanggalToday').value;
          //   // var tambahToday = tD.options[tD.selectedIndex].value;

          //   var ket = document.getElementByID();
